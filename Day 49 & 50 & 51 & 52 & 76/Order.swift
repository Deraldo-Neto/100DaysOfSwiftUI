...
//import SwiftUI
//
//class Order: ObservableObject, Codable { //Essa classe é observada por todo o meu código, por isso as propriedades dela são todas Published, Não pode ser Codable por conta dos Publisheds, lembrando que o codable é o encodable e o decodable juntos
